...
class Square extends Shape {
   render(){
        ...
        return `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg">
            <rect x="50" y="50" width="150" height="200" fill="${this.color}" />
            <text x="125" y="140" font-family="Arial" font-size="50" fill="${this.textColor}" text-anchor="middle">${this.text}</text>
        </svg>`;
   }
}
